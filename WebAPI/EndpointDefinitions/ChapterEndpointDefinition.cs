...
public class ChapterEndpointDefinition : IEndpointDefinition
{
    ...
    {
        var createChapter = new CreateChapter { Title = chapter.Title, Description = chapter.Description };
    ...
    {
        var updateChapter = new UpdateChapter { ChapterId = new ChapterId(id), Title = chapter.Title, Description = chapter.Description };
